...
@export var blacksmith_scene_path: String = "res://minigames/blacksmith/scenes/beat_forge.tscn"
@export var tutorial_scene_path: String = "res://tutorial/tutorial_forge.tscn"
...
func _do_enter_with_fade() -> void:
	...
	var minigame_scene = load(blacksmith_scene_path)
